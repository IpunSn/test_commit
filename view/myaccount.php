...
?>
<main class="w-full h-auto py-10 relative">
  ...
  <button 
      class="uppercase w-fit mx-auto mt-6 text-md font-bold text-white bg-black rounded-md py-3 px-6 hover:shadow-mysd duration-300 hover:shadow-gray-500 hover:-translate-y-1 hover:-translate-x-1 active:shadow-none active:translate-y-0 active:translate-x-0">
