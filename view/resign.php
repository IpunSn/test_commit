<?php if(isset($eror)) : ?>
<div
    class="fixed right-[20%] mt-5  px-3 py-3 rounded-lg text-black text-lg bg-red-300 font-bold flex items-center gap-x-2 shadow-md shadow-gray-300">
    <i class='text-white bx bx-md bx-check rounded-full bg-red-500'></i>
    <span><?=$eror?></span>
</div>
...
<script>
  function validateForm() {
      ...
      // if (password.length < 8 || !/\d/.test(password) || !/^\d{10,11}$/.test(password)) {
