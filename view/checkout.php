...
foreach ($_SESSION['cart'] as $item) {
    ...
    foreach($payment as $pttt){
        ...
        <div class="w-full   flex gap-x-5">
                                ...
                                <label for="'.$payment_id.'" class="w-full p-2 border-2 rounded border-black  peer-checked:text-white peer-checked:border-2   peer-checked:bg-black ">
...
<main class="w-full h-auto py-10">
    <section class="w-[1240px] mx-auto">
        <form action="index.php?page=donhang" method="post"class="w-full flex gap-x-[50px]">
            <!-- form -->
            <div class="w-[60%] h-fit pt-5 pb-12  rounded-lg shadow-[4px_4px_15px_gray] mx-auto">
                <div class="flex flex-col w-[600px] mx-auto gap-y-5 ">
            ...
            <!-- cart -->
            <div class="w-[calc(40%-50px)] p-5  rounded-lg shadow-[-5px_5px_15px_2px_rgba(0,0,0,0.3)]">
                <div class="w-full">
