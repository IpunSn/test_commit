...
foreach($sp_lien_quan as $lienquan){
    ...
    <div
                ...
                <div class="flex justify-center h-[222px]">
                    <img class="w-[222px]" src="view/img/'.$lienquan['img'].'" alt="" />
                </div>
...
<main class="w-full h-auto py-10">
        ...
        <form action="index.php?page=add-cart" method="post" class="w-full flex gap-x-[50px] py-10">
            ...
            <div class="w-1/3  mx-auto ">
                <div class="w-full  bg-[#f2f2f2]  relative rounded-xl border border-black">
                    ...
                    <img id="anh-goc" class="rounded-2xl w-full h-[360px] mx-auto duration-300" src="view/img/<?=$img?>"
                        alt="">
    ...
    <section class="w-[1240px] mx-auto">
        ...
        <div class="w-full py-5  mt-12">
            <h1>Hỏi và đáp</h1>
            <form action="index.php?page=cmt" method="post" class="w-full flex justify-between mt-5" action="">
                <textarea class="w-[766px] h-[222px] p-2.5 rounded-lg border border-black " name="noidung"  id="" cols="50"
                    rows="5" placeholder="Để lại bình luận của bạn"></textarea>
                <?php
    if(isset($_SESSION['user'])){
        $btn_cmt='
        <button
                    class="w-28 h-14 text-xl font-bold text-white bg-black rounded-[20px] p-2.5 group hover:shadow-mysd duration-300 hover:shadow-gray-500 hover:-translate-y-1 hover:-translate-x-1 active:shadow-none active:translate-y-0 active:translate-x-0"
                    type="submit" name="btn-cmt"> <i class="group-hover:-rotate-45 duration-500   bx bx-send"></i> Gửi </button>
        ';
    }else {
        $btn_cmt='
        <a href="index.php?page=login"
                    class="w-fit h-14 text-xl font-bold text-white bg-black rounded-[20px] p-2.5 group hover:shadow-mysd duration-300 hover:shadow-gray-500 hover:-translate-y-1 hover:-translate-x-1 active:shadow-none active:translate-y-0 active:translate-x-0"
...
?>
            ...
            <?php
                ...
                foreach($comment_idsp as $cmt){
                    ...
                    <div class="w-[766px] p-2.5 flex flex-col gap-y-2">
