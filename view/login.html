    ...
    <div class="w-[1480px] px-5 my-0 mx-auto font-roboto">
      ...
      <main class="w-full h-auto py-10">
        <div class="w-[400px]  mx-auto h-auto flex flex-col justify-center items-center gap-y-5">
            <form action="" method="post" class="w-full p-5 flex flex-col gap-y-5 shadow-xl shadow-gray-300 rounded-lg">
                ...
                <input
                    ...
                    type="text" id="name" name="name" placeholder="Email">
    
                <input
                    class="border border-gray-300 px-4 py-2 rounded-md transition duration-300 hover:border-blue-500 focus:outline-none focus:ring focus:border-blue-500"
                    type="tel" id="phone" name="phone" placeholder="Mật Khẩu">
            ...
            <div class="flex flex-col mt-5">
              ...
              <a class="w-fit  mt-2 text-xl font-bold border border-black text-black bg-white rounded-md py-3 px-6 hover:shadow-mysd duration-300 hover:shadow-gray-500 hover:-translate-y-1 hover:-translate-x-1 active:shadow-none active:translate-y-0 active:translate-x-0" href="index.php?page=resign">Đăng ký</a>
            </div>
