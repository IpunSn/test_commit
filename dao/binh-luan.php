...
require_once 'pdo.php';
    ...
    function insert_cmt($noidung,$ngaybinhluan,$iduser,$idsp){
        $sql="INSERT INTO comment(noidung,ngaybinhluan,iduser,idsp) VALUES(?,?,?,?)";
        pdo_execute($sql,$noidung,$ngaybinhluan,$iduser,$idsp);
    }

    function comment_idsp($idsp){
        $sql="SELECT * FROM comment where idsp=?";
